1. Spring DI. Запуск. [#2091]
 Петр Арсентьев,  24.03.20 1:35
Spring состоит из модулей. Но в основе всех модулей режим базовый модуль - Spring DI.

Принцип его работы был описан в предыдущем уроке. В этом уроке мы сделаем туже задачу, что и в предыдущем уроке, но через Spring DI.
