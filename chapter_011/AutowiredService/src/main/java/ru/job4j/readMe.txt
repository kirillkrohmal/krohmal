...
В предыдущем уроке мы изменили регистрацию классов через метод регистрации на @Component.

Класс StartUI зависит от класса Store. Spring определяем зависимость через конструктор.
