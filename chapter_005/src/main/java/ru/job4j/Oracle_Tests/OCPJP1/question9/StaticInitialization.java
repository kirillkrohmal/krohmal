package ru.job4j.Oracle_Tests.OCPJP1.question9;
...
/**
 * Статик-блоки запускаются во время инициализации класса. Весь вопрос в том, когда класс инициализируется, а это
