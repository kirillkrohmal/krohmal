...
class Test {
    public static void main(String[] args) {
        ...
        System.out.print((ru.job4j.Oracle_Tests.OCPJP1.question5.other.Other.hello == hello) + " ");
 ...
 * 6. Метод intern в любом случае возвращает объект из пула, вне зависимости от того, когда создается строка,
 * на этапе компиляции или выполнения. (Поэтому последний вывод — true).
