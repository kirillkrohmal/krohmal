...
В Java NaN'ы несравнимы между собой. Но есть два исключения в работе класса Float:
   ...
   1. Если f1 и f2 оба представляют Float.NaN, тогда метод equals возвращает true, в то время как Float.NaN==Float.NaN
   принимает значение false 2. Если f1 содержит +0.0f в то время как f2 содержит -0.0f, метод equal возвращает false,
