...
public class Orders {
    ...
    public boolean equals(Object o) {
        ...
        return id == orders.id && Float.compare(orders.price, price) == 0 && volume == orders.volume && Objects.equals(book, orders.book) && type == orders.type && Objects.equals(action, orders.action);
    }
