...
public class StubInputTest {
    ...
    public void whenUserFindAllItemThenTrackerHasNewItemWithSameName() {
        ...
        Item item = new Item("key001", "1", "test name1", "desc1", new String[]{}, 2017);
        tracker.add(item);
    ...
    public void whenUserFindByIdItemThenTrackerHasNewItemWithSameName() {
        Tracker tracker = new Tracker();//key, id, name, desc, creat
        Item item = new Item("key002", "2", "test name2", "desc2",new String[]{}, 2017);
        tracker.add(item);
        Input input = new StubInput(new String[]{
    ...
    public void whenUserDeleteItemThenTrackerHasItems() {
        Tracker tracker = new Tracker();//key, id, name, desc, creat
        Item item = new Item("key003", "3", "test name3", "desc3",new String[]{}, 2017);
        tracker.add(item);
        Item item2 = new Item("key004", "4", "test name4", "desc4",new String[]{}, 2017);
        tracker.add(item2);
        Item item3 = new Item("key005", "5", "test name5", "desc5",new String[]{}, 2017);
        tracker.add(item3);
        Item item4 = new Item("key006", "6", "test name6", "desc6",new String[]{}, 2017);
        tracker.add(item4);
        Item item5 = new Item("key007", "7", "test name7", "desc7",new String[]{}, 2017);
        tracker.add(item5);
        Item item6 = new Item("key008", "8", "test name8", "desc8",new String[]{}, 2017);
        tracker.add(item6);
        Item item7 = new Item("key009", "9", "test name9", "desc9",new String[]{}, 2017);
        tracker.add(item7);
    ...
    public void whenUserUpdateItemThenTrackerHasAnotherItem() {
        Tracker tracker = new Tracker();//key, id, name, desc, creat
        Item item = new Item("key004", "9", "test name4", "desc4",new String[]{}, 2017);
        tracker.add(item);
        Input input = new StubInput(new String[]{
