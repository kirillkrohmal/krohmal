...
public class StubInputTest {
    ...
    public void whenShowAllItemsThenTrackerHasShowItemWithSameName() {
        Tracker tracker = new Tracker();//key, id, name, desc, creat
        Input input = new StubInput(new String[]{"0", "key001", "1", "test name1", "desc1", "6"});
        Input input1 = new StubInput(new String[]{"1", "key001", "1", "test name1", "desc1", "6"});
        new StartUI(input, tracker).init();
    ...
    public void whenUserUpdateItemThenTrackerHasAnotherItem() {
        ...
        Input input1 = new StubInput(new String[]{"0", "key006", "6", "test name6", "desc6", "6"});
        Input input2 = new StubInput(new String[]{"2", "key006", "6", "test name6", "desc6", "6"});
        new StartUI(input, tracker).init();
        new StartUI(input1, tracker).init();
        new StartUI(input2, tracker).init();
